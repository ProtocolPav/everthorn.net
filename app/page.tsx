    ...
    <section className="container grid items-center gap-6 pb-8 pt-6 md:py-10">
      <div className="mx-auto flex max-w-[980px] flex-col items-center gap-2 text-center">
        ...
        <h1 className="text-2xl font-extrabold leading-tight tracking-tighter md:text-7xl">
          <span>
            The hub for all that is <br />{" "}
          </span>
          <span className="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-6xl text-transparent md:text-8xl">
            Everthorn
          </span>
        </h1>
        <p className="max-w-[700px] text-lg text-muted-foreground">
          Everything Everthorn. All in one place.{" "}
      ...
      <section
        className={
          "mx-auto mt-5 grid grid-rows-2 items-center gap-x-9 gap-y-7 lg:mx-0 lg:grid-cols-3 lg:items-start"
        }
      >
        <div>
        ...
        <div className="row-span-1">
          <h1 className="col-span-1 items-start text-2xl font-extrabold leading-tight tracking-tighter md:text-4xl">
            <span>
              Lore. Stories. Wiki. <br /> We got it.{" "}
            </span>
          </h1>
          <p className="mt-2 max-w-[700px] text-lg text-muted-foreground">
            The wiki is the place to read and write stories.
            <br />
      ...
      <section className="mx-auto mt-12 text-center">
        ...
        <p className="mt-2 text-lg text-muted-foreground">
          Support the server by becoming a{" "}
          <b className={"text-attention2"}>Patron!</b> <br /> Donating helps
          keep Everthorn running, and also provides Thorny with dinner every
          night.
        </p>
