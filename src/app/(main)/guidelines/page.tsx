      ...
      <section className="mx-5 grid items-center gap-6 pb-8 pt-6 md:mx-10 md:py-10 xl:mx-20">
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            <AccordionTrigger>
              <span className={'flex gap-2'}> Server Rules <Badge variant={'attention'}>Must-Read</Badge> </span>
            </AccordionTrigger>
          ...
          <AccordionItem value="item-2">
            <AccordionTrigger>
              <span className={'flex gap-2'}> Discord Rules </span>
            </AccordionTrigger>
            <AccordionContent className={'text-muted-foreground'}>
              <ul className='flex max-w-[800px] list-disc flex-col space-y-4 pl-8 pt-2'>
                <li>
          ...
          <AccordionItem value="item-3">
            <AccordionTrigger>
              <span className={'flex gap-2'}> Projects <Badge variant={'attention'}>Must-Read</Badge> </span>
            </AccordionTrigger>
            <AccordionContent className="text-muted-foreground">
          ...
          <AccordionItem value="item-4">
            <AccordionTrigger>
              <span className={'flex gap-2'}> Events, Quests & Monthly Market </span>
            </AccordionTrigger>
          ...
          <AccordionItem value="item-5">
            <AccordionTrigger>
              <span className={'flex gap-2'}> Natural Progression </span>
            </AccordionTrigger>
            <AccordionContent className="max-w-[800px] pl-2 pt-2 text-muted-foreground">
          ...
          <AccordionItem value="item-6">
            <AccordionTrigger>
              <span className={'flex gap-2'}> Connecting To The Server <Badge variant={'attention'}>Must-Read</Badge> </span>
            </AccordionTrigger>
            <AccordionContent className="max-w-[800px] pl-2 pt-2 text-muted-foreground">
