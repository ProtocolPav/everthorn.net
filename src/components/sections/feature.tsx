...
export default function Feature({className}: {className?: string | undefined}) {
    return (
        <div className={cn(className, 'grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5')}>
            ...
            <Card className={'bg-gradient-to-tr from-background to-rose-400/20'}>
                <CardHeader className={'flex pb-0'}>
                    <h3 className={'flex items-center justify-start gap-2 text-xl'}>
            ...
            <Card className={'bg-gradient-to-tl from-background to-blue-400/20'}>
                <CardHeader className={'flex pb-0'}>
                    <h3 className={'flex items-center justify-start gap-2 text-xl'}>
            ...
            <Card className={'bg-gradient-to-br from-background to-orange-400/20'}>
                <CardHeader className={'flex pb-0'}>
                    <h3 className={'flex items-center justify-start gap-2 text-xl'}>
            ...
            <Card className={'bg-gradient-to-bl from-background to-violet-400/20'}>
                <CardHeader className={'flex pb-0'}>
                    <h3 className={'flex items-center justify-start gap-2 text-xl'}>
