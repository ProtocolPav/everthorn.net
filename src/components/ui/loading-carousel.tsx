...
export function LoadingCarousel({
    ...
    return (
        <motion.div
            ...
            className={cn(
                "mx-auto w-full max-w-6xl rounded-lg bg-transparent",
                className
            )}
        >
                            ...
                            {(displayTips || []).map((tip, index) => (
                                <CarouselItem key={index}>
                                    <motion.div
                                        ...
                                        className={`relative aspect-square w-full overflow-hidden md:aspect-video`}
                                    >
                                        <Image
                                            src={tip.image}
                                        ...
                                        {backgroundTips ? (
                                            ...
                                            >
                                                {displayTips[current]?.url ? (
                                                    ...
                                                    >
                                                        <p className="text-left text-base font-medium leading-relaxed tracking-tight text-white sm:text-lg md:text-xl lg:text-2xl lg:font-bold">
                                                            {tip.text}
                                                        </p>
                                                    </a>
                                                ) : (
